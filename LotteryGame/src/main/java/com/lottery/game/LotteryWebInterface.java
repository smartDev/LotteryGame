...
public interface LotteryWebInterface {
    ...
    @ResponseBody
    LotteryTicket createLotteryTicket(@RequestParam(value = "numberLines") Integer numberLines);
    ...
    @ResponseBody
    LotteryTicket addLineToTicket(@RequestParam(value = "numberLines") Integer numberLines, @RequestParam(value = "ticketId") Long ticketId);
    ...
    @ResponseBody
    TicketResult checkTicket(@RequestParam(value = "ticketId") Long ticketId);


    /**
     * Check Lottery Ticket API
     * This API supports HTTP GET Method Only
     * It is used to mark and return the tickets of a Lottery Ticket
     * Example:
     * http://localhost:8080/lottery/ticket/
     * <p>
     * Response:
     * [{"lines":[{"lineNumbers":[2,1,1]},{"lineNumbers":[0,0,2]}],"checked":false,"ticketId":1},{"lines":[{"lineNumbers":[2,1,0]},{"lineNumbers":[0,1,0]},{"lineNumbers":[1,1,0]}],"checked":false,"ticketId":2}]
     *
     * @return
     */
    @RequestMapping(value = "/ticket/", method = RequestMethod.GET)
    @ResponseBody
    ArrayList<LotteryTicket> getAllTickets();
}
